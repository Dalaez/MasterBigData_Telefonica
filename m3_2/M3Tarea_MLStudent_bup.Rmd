...
#corrplot(matCor, method = "shade", shade.col = NA, tl.col = "black",         order="AOE",         mar=c(1,0,2,0), line=-2,         main = "Matriz de Correlación \"Matemáticas\"")

#Visualización 3 - Con valores numéricos
...
## MODELOS SUPERVISADOS - PREDICCIÓN REGRESIÓN LINEAL Y CLASIFICACIÓN CON ÁRBOLES DE DECISIÓN
